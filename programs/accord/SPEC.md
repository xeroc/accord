...
| `Dispute`       | `["dispute", filer, nonce]`              | `subaccord`, `options: [..; MAX]`, `evidence_hash: [u8;32]`, `state`, `current_round`, `terms: CaseTerms` (filing-time freeze of economics + `aggregation` + `appeal_window`, ADR-0019/0022), `final_ruling: u8` (`u8::MAX` until `Final`), `fee_paid: u64` (running available fee pool, ADR-0020), `committed_vrf: Option<[u8;32]>`, `frozen_root: [u8;32]` (set in `commit_vrf_callback`), `frozen_total_stake: u64`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
