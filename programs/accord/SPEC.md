...
| --------------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Subaccord`     | `["subaccord", creator, risk_type_hash]` | `staking_token` (mint), `min_stake`, `initial_num_jurors` (round-1 seed; appeals grow the panel via `2N+1`, ADR-0019), `alpha_bps` (slash = `alpha_bps * min_stake / 10_000`), `review/commit/reveal_window`, `max_appeals`, `aggregation: Aggregation` (v1 = `Plurality`; the dispute-kit tally rule, ADR-0019), `fee_per_juror`, `authority: Pubkey` (`default` ⇒ immutable), `evidence_operator: Pubkey`. `risk_type` + `evidence_spec` immutable. **Accumulator:** `root_hash: [u8;32]`, `total_stake: u64`, `next_index: u32`, `depth: u8` (fixed at creation, default 20 ≈ 1M seats). |
| `JurorStake`    | `["stake", subaccord, juror]`            | `amount: u64`, `active_draws: u32`, `tree_index: u32` (assigned at first stake, immutable)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `Dispute`       | `["dispute", filer, nonce]`              | `subaccord`, `options: [..; MAX]`, `evidence_hash: [u8;32]`, `state`, `current_round`, `final_ruling: u8`, `committed_vrf: Option<[u8;32]>`, `frozen_root: [u8;32]` (set in `commit_vrf_callback`), `frozen_total_stake: u64`                                                                                                                                                                                                                                                                                                                                                               |
