...
| H-2 | 🟠 High | `withdraw_fees` drained reserved vault funds (gross-balance cap) | ✅ Fixed — parallel-ledger accumulators on Subaccord; exact `==` invariant; no cap, pulls full `fees_earned` (bean accord-fdad) |
