...
export const ACCORD_ERROR__NOT_REDRAW_ELIGIBLE = 0x17a4; // 6052
/** MaxDrawAttemptsLimitExceeded: Subaccord max_draw_attempts exceeds the program ceiling. */
export const ACCORD_ERROR__MAX_DRAW_ATTEMPTS_LIMIT_EXCEEDED = 0x17a5; // 6053
/** InvalidThreshold: Reveal threshold (bps) must be <= 10_000. */
export const ACCORD_ERROR__INVALID_THRESHOLD = 0x17a6; // 6054
