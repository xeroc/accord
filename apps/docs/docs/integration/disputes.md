...
| `fee`           | `u64`           | **Must equal** `(min_jury_size + 1) · fee_per_juror` (= `4 · fee_per_juror` at the default panel; the extra unit banks into the flip-bounty pool, ADR-0030).                                                                                                                                                 |
...
| `fee == (min_jury_size + 1) · fee_per_juror` (ADR-0030) | `FeeMismatch`        |
