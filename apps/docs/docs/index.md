...
- **Sortition you can verify**: stake-weighted selection is deterministic and
  on-chain verifiable given a committed VRF (ADR-0008/0009; the snapshot layer is
  being replaced by an on-chain accumulator — ADR-0012).
