/**
 * cluster.ts — cluster config (kept for barrel re-export + future consumers).
 * Active-cluster state lives in ConnectorKit (useCluster); read via shared/rpc.
 */
...
export const CLUSTERS: ClusterConfig[] = [
  { id: "devnet", label: "Devnet", url: DEVNET_RPC, urlWs: toWsUrl(DEVNET_RPC) },
  {
    id: "mainnet-beta",
    label: "Mainnet",
    url: MAINNET_RPC,
  ...
  { id: "localnet", label: "Localnet", url: "http://localhost:8899", urlWs: "ws://localhost:8900" },
];
