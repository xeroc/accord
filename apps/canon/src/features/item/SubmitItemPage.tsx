    ...
    return (
      <div className="page">
        ...
        <div className="empty">
          ...
          <p className="empty-body">No CanonList at {shortAddress(address)}.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="page">
      ...
      <div className="page-head">
        <h1 className="title mono">Submit item</h1>
        <p className="lede mono">to list {shortAddress(list.data.address)}</p>
      </div>
      ...
      <form onSubmit={onSubmit} className="form detail-group" style={{ maxWidth: "560px" }}>
        <div className="field">
          ...
          {!ownershipDisabled && ownerQuery.data !== undefined && (
            <span className={ownerMatch ? "check-ok" : "check-bad"}>
              {ownerMatch
        ...
        <div className="field">
          ...
          />
          {evidenceError ? (
            <p className="form-error">{evidenceError}</p>
          ) : (
            <span className="help">32-byte sha256 of the off-chain evidence (hex).</span>
          )}
        </div>
