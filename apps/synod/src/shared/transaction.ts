 ...
 *
 * Mirrors apps/canon/src/shared/transaction.ts.
 */
 ...
 * reverted before we ever broadcast. Carries the full program `logs`;
 * {@link describeError} extracts a clean one-line reason for toasts.
 */
