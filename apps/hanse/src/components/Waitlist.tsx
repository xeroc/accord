...
// Waitlist form — same list as useaccord.xyz: POSTs { email, type,
// timestamp } to VITE_N8N_WEBHOOK_URL (n8n webhook, routes on `type`).
// Submit logic lives in ../lib/waitlist (testable seam, shared with the
// landing app's contract).
